...
```
$ ./1-world_wide_web Aiman.tech
The subdomain www is a A record and points to 100.25.221.232
The subdomain lb-01 is a A record and points to 100.25.221.232
The subdomain web-01 is a A record and points to 3.235.65.113
The subdomain web-02 is a A record and points to 100.25.211.108

$ ./1-world_wide_web Aiman.tech web-01
The subdomain web-01 is a A record and points to 3.235.65.113
```
